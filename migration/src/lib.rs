...
mod m20250525_191252_create_filckr_photo_sizes;
mod m20250525_195757_create_filckr_photos;
mod m20250525_205645_create_filckr_photosets;
...
impl MigratorTrait for Migrator {
    fn migrations() -> Vec<Box<dyn MigrationTrait>> {
        vec![
            ...
            Box::new(m20250525_191252_create_filckr_photo_sizes::Migration),
            Box::new(m20250525_195757_create_filckr_photos::Migration),
            Box::new(m20250525_205645_create_filckr_photosets::Migration),
